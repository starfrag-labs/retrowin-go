...
func (_c *GroupCreate) SetCreateTime(v time.Time) *GroupCreate {
	_c.mutation.SetCreateTime(v)
	return _c
}

// SetNillableCreateTime sets the "create_time" field if the given value is not nil.
func (_c *GroupCreate) SetNillableCreateTime(v *time.Time) *GroupCreate {
	if v != nil {
		_c.SetCreateTime(*v)
	}
	return _c
...
func (_c *GroupCreate) SetUpdateTime(v time.Time) *GroupCreate {
	_c.mutation.SetUpdateTime(v)
	return _c
}

// SetNillableUpdateTime sets the "update_time" field if the given value is not nil.
func (_c *GroupCreate) SetNillableUpdateTime(v *time.Time) *GroupCreate {
	if v != nil {
		_c.SetUpdateTime(*v)
	}
	return _c
...
func (_c *GroupCreate) SetSystemID(v int64) *GroupCreate {
	_c.mutation.SetSystemID(v)
	return _c
}

// SetGid sets the "gid" field.
func (_c *GroupCreate) SetGid(v string) *GroupCreate {
	_c.mutation.SetGid(v)
	return _c
}

// SetGroupname sets the "groupname" field.
func (_c *GroupCreate) SetGroupname(v string) *GroupCreate {
...
func (_c *GroupCreate) SetSystem(v *System) *GroupCreate {
	return _c.SetSystemID(v.ID)
}

// AddUserIDs adds the "users" edge to the User entity by IDs.
func (_c *GroupCreate) AddUserIDs(ids ...int64) *GroupCreate {
...
func (_c *GroupCreate) check() error {
	...
	if _, ok := _c.mutation.SystemID(); !ok {
		return &ValidationError{Name: "system_id", err: errors.New(`ent: missing required field "Group.system_id"`)}
	}
	if _, ok := _c.mutation.Gid(); !ok {
		return &ValidationError{Name: "gid", err: errors.New(`ent: missing required field "Group.gid"`)}
	}
	...
	if len(_c.mutation.SystemIDs()) == 0 {
		return &ValidationError{Name: "system", err: errors.New(`ent: missing required edge "Group.system"`)}
	}
	return nil
}
