...
func (_q *GroupQuery) QuerySystem() *SystemQuery {
...
func (_q *GroupQuery) WithSystem(opts ...func(*SystemQuery)) *GroupQuery {
	query := (&SystemClient{config: _q.config}).Query()
...
func (_q *GroupQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Group, error) {
	...
	if query := _q.withSystem; query != nil {
		if err := _q.loadSystem(ctx, query, nodes, nil,
			func(n *Group, e *System) { n.Edges.System = e }); err != nil {
			return nil, err
		}
	}
...
func (_q *GroupQuery) loadSystem(ctx context.Context, query *SystemQuery, nodes []*Group, init func(*Group), assign func(*Group, *System)) error {
...
func (_q *GroupQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withSystem != nil {
			_spec.Node.AddColumnOnce(group.FieldSystemID)
		}
	}
