...
const (
	// Label holds the string label denoting the filerole type in the database.
	Label = "file_role"
	...
	FieldRoles = "roles"
	// Table holds the table name of the filerole in the database.
	Table = "file_roles"
)

// Columns holds all SQL columns for filerole fields.
var Columns = []string{
	FieldID,
	FieldCreateTime,
	FieldUpdateTime,
...
// OrderOption defines the ordering options for the FileRole queries.
