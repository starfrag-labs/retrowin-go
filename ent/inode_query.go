...
func (_q *InodeQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *InodeQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *InodeQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *InodeQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *InodeQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *InodeQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *InodeQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(inode.Table, inode.Columns, sqlgraph.NewFieldSpec(inode.FieldID, field.TypeInt64))
	_spec.From = _q.sql
