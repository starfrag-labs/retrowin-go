...
// CreateWithID provides a mock function for the type ObjectRepositoryMock
func (_mock *ObjectRepositoryMock) CreateWithID(ctx context.Context, client *ent.Client, id string, params *object.CreateParams) (*object.Object, error) {
	ret := _mock.Called(ctx, client, id, params)

	if len(ret) == 0 {
		panic("no return value specified for CreateWithID")
	}

	var r0 *object.Object
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, *ent.Client, string, *object.CreateParams) (*object.Object, error)); ok {
		return returnFunc(ctx, client, id, params)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, *ent.Client, string, *object.CreateParams) *object.Object); ok {
		r0 = returnFunc(ctx, client, id, params)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*object.Object)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, *ent.Client, string, *object.CreateParams) error); ok {
		r1 = returnFunc(ctx, client, id, params)
	} else {
		r1 = ret.Error(1)
	}
	return r0, r1
...
// ObjectRepositoryMock_CreateWithID_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CreateWithID'
type ObjectRepositoryMock_CreateWithID_Call struct {
	*mock.Call
}

// CreateWithID is a helper method to define mock.On call
//   - ctx context.Context
//   - client *ent.Client
//   - id string
//   - params *object.CreateParams
func (_e *ObjectRepositoryMock_Expecter) CreateWithID(ctx interface{}, client interface{}, id interface{}, params interface{}) *ObjectRepositoryMock_CreateWithID_Call {
	return &ObjectRepositoryMock_CreateWithID_Call{Call: _e.mock.On("CreateWithID", ctx, client, id, params)}
}

func (_c *ObjectRepositoryMock_CreateWithID_Call) Run(run func(ctx context.Context, client *ent.Client, id string, params *object.CreateParams)) *ObjectRepositoryMock_CreateWithID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		...
		var arg3 *object.CreateParams
		if args[3] != nil {
			arg3 = args[3].(*object.CreateParams)
		}
		run(
			arg0,
			arg1,
...
func (_c *ObjectRepositoryMock_CreateWithID_Call) Return(object1 *object.Object, err error) *ObjectRepositoryMock_CreateWithID_Call {
	_c.Call.Return(object1, err)
	return _c
}

func (_c *ObjectRepositoryMock_CreateWithID_Call) RunAndReturn(run func(ctx context.Context, client *ent.Client, id string, params *object.CreateParams) (*object.Object, error)) *ObjectRepositoryMock_CreateWithID_Call {
	_c.Call.Return(run)
	return _c
}
